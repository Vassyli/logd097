...
CREATE TABLE accounts (
  ...
  specialmisc text NULL,
  login varchar(50) NOT NULL default '',
  slainby varchar(50) NOT NULL default '',
  lastmotd datetime NULL default NULL,
  playerfights int(11) unsigned NOT NULL default '3',
  lasthit datetime NULL default NULL,
  ...
  prefs text NULL,
  pvpflag datetime NULL default NULL,
  ...
  buffbackup text NULL,
  biotime datetime NULL default NULL,
  history text NULL,
  ...
  lastwebvote date NULL default NULL,
...
CREATE TABLE mounts (
  ...
  newday tinytext NULL,
  recharge text NULL,
  partrecharge text NULL,
  ...
  mine_tethermsg text NULL,
  mine_deathmsg text NULL,
  mine_savemsg text NULL,
  PRIMARY KEY  (mountid),
  KEY mountid (mountid)
) ;
